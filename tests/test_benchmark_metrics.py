"""Unit tests for DFIRLlama benchmark metric calculations — TUS, RS, CCR, BenchmarkReport."""

import pytest
from tools.benchmark import (
    _compute_tus, _compute_context_recall,
...
def test_rs_mixed():
    # 3 correct (+1 each) + 1 wrong (-2) → rs_raw=1, normalized=(1+8)/12=0.75
