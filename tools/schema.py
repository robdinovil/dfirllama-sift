"""
Normalized forensic SQLite schema for DFIRLlama evidence ingestion.

Seven evidence tables cover the Windows artifacts most commonly collected
during incident response: event logs, process snapshots, network state,
scheduled tasks, registry exports, system info, and DNS cache.
All tables carry source_file for chain-of-custody traceability.
"""
